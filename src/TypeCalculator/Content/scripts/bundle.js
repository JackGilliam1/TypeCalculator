...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./typecalculator.scss", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./typecalculator.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6),
	    ...
	    TypeDropdown = __webpack_require__(174),
	    Sidebar = __webpack_require__(175),
	...
	module.exports = TypeCalculator = React.createClass({
	  ...
	  render: function () {
	    ...
	    if(this.state.layout === 'Table') {
	      ...
	      rightSection = 
	        React.createElement(TypesColumnLayout, {
	    ...
	    return (
	      React.createElement("div", {id: "main"}, 
	        React.createElement(TypeDropdown, {
	...
	$(document).ready(function() {
	  ReactDOM.render(React.createElement(TypeCalculator, null), document.getElementById("mainContainer"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var UpdateStatus = React.createClass({displayName: "UpdateStatus",
	  render: function() {
	    return (
	      React.createElement("span", {id: "statusBadge"}, this.props.status)
	    );
	  }
	});
	...
	module.exports = React.createClass({
	  ...
	  toListItems: function(types, selectedType) {
	    ...
	    return types.map(function(type) {
	      ...
	      return React.createElement("option", {key: type, value: lowerType}, type);
	    });
	  },
	  render: function () {
	    var defaultElement = React.createElement("option", {key: "None", value: "none"}, "None"),
	    ...
	    return (
	      React.createElement("div", {id: "typeDropdown", className: "centered at-top stretch"}, 
	        React.createElement("select", {id: "typeSelectOne", value: selectedFirstType, onChange: firstTypeChanged}, 
	          firstElements
	        ), 
	        React.createElement("select", {id: "typeSelectTwo", value: selectedSecondType, onChange: secondTypeChanged}, 
	          secondElements
	        ), 
	        React.createElement(UpdateStatus, {status: this.props.status})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  toListItems: function(types, onClick, selectedType) {
	    ...
	    return (
	      React.createElement("span", {id: "sidebarList", className: "sidebar"}, 
	        React.createElement("div", {id: "typeOneSidebarSelect", className: "sidebar-section"}, 
	          React.createElement("li", {className: "selection-item selection-header"}, "First"), 
	          firstElements
	        ), 
	        React.createElement("div", {id: "typeTwoSidebarSelect", className: "sidebar-section"}, 
	          React.createElement("li", {className: "selection-item selection-header"}, "Second"), 
	          secondElements
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var TypeColumn = __webpack_require__(177);
	...
	module.exports = React.createClass({
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {id: "typesColumnSection", className: "main-section"}, 
	        React.createElement(TypeColumn, {className: "attackSection strong type-column", columnTitle: "Strong Attack Against", types: this.props.strongAttack}), 
	        React.createElement(TypeColumn, {className: "attackSection weak type-column", columnTitle: "Weak Attack Against", types: this.props.weakAttack}), 
	        React.createElement(TypeColumn, {className: "defenseSection strong type-column", columnTitle: "Strong Defense Against", types: this.props.strongDefense}), 
	        React.createElement(TypeColumn, {className: "defenseSection weak type-column", columnTitle: "Weak Defense Against", types: this.props.weakDefense}), 
	        React.createElement(TypeColumn, {className: "defenseSection immune type-column", columnTitle: "Immune Defense", types: this.props.immuneDefense})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var TypeListItem = __webpack_require__(178);
	...
	module.exports = React.createClass({
	  ...
	  emptyColumn: React.createElement(TypeListItem, {key: "None", type: "None"}),
	  render: function() {
	    var className = this.props.className,
	        columnTitle = this.props.columnTitle,
	        elementTypes = this.props.types.map(function(type) {
	          return (
	            React.createElement(TypeListItem, {key: type, type: type})
	          );
	        });

	    return (
	      React.createElement("span", {className: className}, 
	        React.createElement("h2", null, columnTitle), 
	        React.createElement("div", {className: "types"}, 
	          React.createElement("li", {id: "count", className: "count"}, 'Type Count: ' + elementTypes.length), 
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = React.createClass({displayName: "exports",
	    render: function() {
	        ...
	        return (
	          React.createElement("li", {key: elementType, className: "type " + elementType.toLowerCase().split(' ')[0]}, elementType)
	        ); 
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6),
	    $ = __webpack_require__(173),
	    EmptyTable = __webpack_require__(182),
	    TableHeaderRows = __webpack_require__(183),
	    TableBodyRows = __webpack_require__(184);
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    ...
	    if(!stats) {
	      return React.createElement(EmptyTable, null);
	    }

	    return (
	      React.createElement("div", {id: "typesTableSection", className: "main-section"}, 
	        React.createElement("table", {className: "stat-table"}, 
	          React.createElement(TableHeaderRows, {stats: stats}), 
	          React.createElement(TableBodyRows, {selectedFirstType: this.props.selectedFirstType || 'None', selectedSecondType: this.props.selectedSecondType || 'None', stats: stats, onCellClick: this.props.onCellClick})
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./typestablelayout.scss", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./typestablelayout.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(3)();
	exports.push([module.id, ".stat-table {\n  background: whitesmoke;\n  border-spacing: 0px;\n  border: 2px solid black; }\n  .stat-table .type {\n    color: white;\n    background: #68A090; }\n  .stat-table .none {\n    background: #68A090; }\n  .stat-table .bug {\n    background: #A8B820; }\n  .stat-table .dark {\n    background: #705848; }\n  .stat-table .dragon {\n    background: #7038F8; }\n  .stat-table .electric {\n    background: #F8D030; }\n  .stat-table .fairy {\n    background: #EE99AC; }\n  .stat-table .fighting {\n    background: #C03028; }\n  .stat-table .fire {\n    background: #F08030; }\n  .stat-table .flying {\n    background: #A890F0; }\n  .stat-table .ghost {\n    background: #7038F8; }\n  .stat-table .grass {\n    background: #78C850; }\n  .stat-table .ground {\n    background: #E0C068; }\n  .stat-table .ice {\n    background: #98D8D8; }\n  .stat-table .normal {\n    background: #A8A878; }\n  .stat-table .poison {\n    background: #A040A0; }\n  .stat-table .psychic {\n    background: #F85888; }\n  .stat-table .rock {\n    background: #B8A038; }\n  .stat-table .steel {\n    background: #B8B8D0; }\n  .stat-table .water {\n    background: #6890F0; }\n  .stat-table .body-cell.selected {\n    cursor: default;\n    background: #AFFFE0;\n    color: black; }\n    .stat-table .body-cell.selected.strong {\n      background: #FF8080;\n      color: white; }\n    .stat-table .body-cell.selected.weak {\n      background: #FFFFD0;\n      color: black; }\n    .stat-table .body-cell.selected.immune {\n      background: darkgray;\n      color: white; }\n    .stat-table .body-cell.selected.vert-selected {\n      border-left: 1px solid darkgreen;\n      border-right: 1px solid darkgreen; }\n    .stat-table .body-cell.selected.horiz-selected {\n      border-top: 1px solid darkgreen;\n      border-bottom: 1px solid darkgreen; }\n    .stat-table .body-cell.selected.horiz-selected.vert-selected {\n      border: 0px; }\n  .stat-table .body-cell.strong {\n    background: #FF0000;\n    color: white; }\n  .stat-table .body-cell.weak {\n    background: #FFFFA0;\n    color: black; }\n  .stat-table .body-cell.immune {\n    background: #808080;\n    color: white; }\n  .stat-table .cell {\n    padding: 6px;\n    text-align: center;\n    width: 50px; }\n    .stat-table .cell.body-cell {\n      border: 1px solid #C4C4C4; }\n  .stat-table .hover .body-cell, .stat-table .hover.body-cell {\n    color: white;\n    background: #6890f0; }\n  .stat-table .hover.body-row .body-cell {\n    border-top: 1px solid #0F0E77;\n    border-bottom: 1px solid #0F0E77; }\n    .stat-table .hover.body-row .body-cell.hover {\n      border: 0px; }\n  .stat-table .hover.body-cell {\n    cursor: pointer;\n    border-left: 1px solid #0F0E77;\n    border-right: 1px solid #0F0E77; }\n    .stat-table .hover.body-cell.strong {\n      background: #FF8080;\n      color: white; }\n    .stat-table .hover.body-cell.weak {\n      background: #FFFFD0;\n      color: black; }\n    .stat-table .hover.body-cell.immune {\n      background: darkgray;\n      color: white; }\n  .stat-table .row .type-cell {\n    font-weight: bold;\n    cursor: default; }\n  .stat-table .row.body-row .type-cell {\n    border-right: 2px solid black; }\n  .stat-table .row.body-row:not(:last-of-type) .type-cell {\n    border-bottom: 2px solid black; }\n  .stat-table .row.header-row .type-cell {\n    border-bottom: 2px solid black; }\n    .stat-table .row.header-row .type-cell:not(:last-of-type) {\n      border-right: 2px solid black; }\n", ""]);
	    ...
	    return (
	        React.createElement("table", {className: "stat-table"}, 
	          React.createElement("thead", {className: "header"}, 
	            React.createElement("tr", {className: "header-row row"}, 
	              React.createElement("td", {className: "header-cell cell"}, "Type"), 
	              React.createElement("td", {className: "header-cell cell none"}, "None")
	            )
	          ), 
	          React.createElement("tbody", {className: "body"}, 
	            React.createElement("tr", {className: "body-row row"}, 
	              React.createElement("td", {className: "type-cell cell none"}, "None"), 
	              React.createElement("td", {className: "body-cell cell"}, "0")
	            )
	          )
	        )
	    );
	  ...
	  render: function() {
	    var currentCell = 0,
	        statHeaders = this.props.stats.map(function(stat) {
	          currentCell += 1;
	          return (
	            React.createElement("td", {key: stat.ElementType, className: "type-cell header-cell cell type " + stat.ElementType.toLowerCase() + " cell-" + currentCell}, stat.ElementType)
	          );
	        });
	    ...
	    return (
	        React.createElement("thead", {className: "header"}, 
	          React.createElement("tr", {className: "header-row row"}, 
	            React.createElement("td", {className: "type-cell header-cell cell"}, "Type"), 
	            statHeaders
	          )
	        )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var staticMethodClass = React.createClass({displayName: "staticMethodClass",
	    statics: {
	      ...
	      var selectedFirstType = this.props.selectedFirstType,
	          ...
	          bodyRows = this.props.stats.map(function(stat) {
	              ...
	              var multipliers = stat.Stats.map(function(elementStat) {
	                ...
	                return (
	                  React.createElement("td", {key: elementStat.ElementType, className: className, onClick: onCellClick}, multiplier)
	                );
	              });

	              return (
	                React.createElement("tr", {key: stat.ElementType, className: className}, 
	                  React.createElement("td", {key: stat.ElementType, className: "type-cell cell type " + stat.ElementType.toLowerCase()}, stat.ElementType), 
	                  multipliers
	                )
	              );
	          });
	        ...
	        return (
	          React.createElement("tbody", {className: "stats-table-body"}, 
	            bodyRows
	          )
	        );
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =  React.createClass({
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {id: "switchLayoutSection"}, 
	        React.createElement("select", {defaultValue: defaultLayout, size: 2, onChange: this.handleChange(this.props.onLayoutSwitch)}, 
	          layoutOptions
	        )
	      )
	    );
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("div", {id: "addTypesSection", className: 'addTypesSection'}, 
	        React.createElement("label", {for: "typeOneInput"}, "Type One"), 
	        React.createElement("input", {name: "typeOneInput", className: 'addTypesInput addTypeOneInput', type: "text"}), React.createElement("br", null), 
	        React.createElement("label", {for: "typeTwoInput"}, "Type Two"), 
	        React.createElement("input", {name: "typeTwoInput", className: 'addTypesInput addTypeTwoInput', type: "text"}), React.createElement("br", null), 
	        React.createElement("label", {for: "typeType"}, "Type Of Damage"), 
	        React.createElement("select", {name: "typeType", className: 'addTypesInput addTypeTypeInput', 
	                value: selectedAddType, onChange: this.handleChange(this.props.selectedAddTypeChange)}, 
	          React.createElement("option", {key: "strongAtk", value: "StrongAttack"}, "Strong Attack Against"), 
	          React.createElement("option", {key: "strongDefRad", value: "StrongDefense"}, "Strong Defense Against"), 
	          React.createElement("option", {key: "weakAtkRad", value: "WeakAttack"}, "Weak Attack Against"), 
	          React.createElement("option", {key: "weakDefRad", value: "WeakDefense"}, "Weak Defense Against"), 
	          React.createElement("option", {key: "immuneRad", value: "ImmuneDefense"}, "Immune Against")
	        ), React.createElement("br", null), 
	        React.createElement("button", {id: "typeSubmit", onClick: this.handleSubmit(this.props.onAddTypes)}, "Submit")
	      )
	      );
	  }
	});
